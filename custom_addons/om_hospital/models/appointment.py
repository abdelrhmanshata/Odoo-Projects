...
class HospitalAppointment(models.Model):
    ...
    appointment_time=fields.Datetime(string='Appointment Time',default=lambda self: fields.Datetime.now())
    booking_date = fields.Date(string="Booking Date",default=fields.Date.context_today)
    ref = fields.Char(string="Reference",default="Odoo Mates",help="Reference to the patient record")
